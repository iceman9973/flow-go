...
//
// Absorbed from github.com/kodelyx/Browser-cdp/cdp-control (its `cdp` package,
// v0.0.0-20260920054928-9aaab4e4a4f7) on 2026-09-22, so flow-go no longer
// depends on that module. Change it in place: there is no upstream to track.
package cdp
